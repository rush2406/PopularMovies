...
public class TrailerUtility {
    public static final String LOG_TAG = TrailerUtility.class.getSimpleName();

    private TrailerUtility() {
    }
    ...
    public static ArrayList<String> fetchData(String requestURL) {
        ...
        ArrayList<String> items = extractMovieData(jsonResponse);
    ...
    private static ArrayList<String> extractMovieData(String DataJSON) {
